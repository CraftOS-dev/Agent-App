...
| `list` | every known Agent App with its port and live-probed status (`running`/`stopped`/`missing`), plus a live dev instance or bridge on the app's own row; `--json`, `--prune` |
