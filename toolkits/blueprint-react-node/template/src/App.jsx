 ...
 * staleness. A CODE change it handles itself (reload when nothing is unsaved).
 * A DATA change it only announces (`a2app:datachange`) — because only this
 * file knows how to re-read without discarding a form someone is filling in.
 */
...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("a2app:datachange", onDataChange);
  }, [loadTasks]);
