/**
 * @craftos/agent-app-kit — the versioned kit a toolkit vendors into an Agent App: shared
...
export const DESIGN_TOKENS_CSS = `/* ============================================================================
   ...
   ships in lockstep with @craftos/agent-app-kit's DESIGN_TOKENS_CSS — keep this body identical).
